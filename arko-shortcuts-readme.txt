...
original Keyboard Shortcuts for vanilla CK2: http://www.arumba.tv/mods/
...
1. Locate a HIP installation that includes a copy of the correct version of
   ...
   Interface version.
2. Extract .7z archive into the HIP folder, overwriting all conflicting files.

USAGE:
See below for Arumba’s original readme explaining the various keyboard
shortcuts. It has been slightly modified for accuracy.
...
CHANGELOG:
v1.0: Initial version for ARKOpack Interface version 2015-02-07
...
Keyboard Shortcuts + Interface Adjust:
	...
	Keyboard Shortcuts:
This adds 10 shortcuts to the game: "z","x","c","v","b","n",",",".","/","l"
...
b will open the new unit interface (ship/army rebalancing) if you have one or two armies/shipgroups selected.
...
n merges selected levies or ships, so long as they are in the same zone or province (naturally). If you have a single army/shipgroup the "n" key will split it in half.
